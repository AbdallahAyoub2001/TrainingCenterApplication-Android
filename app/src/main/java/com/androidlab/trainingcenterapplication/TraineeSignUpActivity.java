...
public class TraineeSignUpActivity extends AppCompatActivity {
    ...
    private EditText etEmail, etFirstName, etLastName, etPassword, etConfirmPassword, mobileNumber, address;
    Button btnSignUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(v -> {
            ...
            if (validate(email, firstName, lastName, password, confirmPassword, userPhoto, mobile_number, userAddress)) {
                TraineeUser trainee = new TraineeUser(email, firstName, lastName, password, userPhoto, mobile_number, userAddress);

                DataBaseHelper dataBaseHelper =new DataBaseHelper(TraineeSignUpActivity.this,"DB_TRAINING_CENTER",null,1);
                try {
                ...
                startActivity(new Intent(TraineeSignUpActivity.this, TraineeHomeViewActivity.class));
                finish();
            }
    ...
    private boolean validate(String email, String firstName, String lastName, String password, String confirmPassword, ImageView photo, String mobile_number, String userAddress) {
        if (email.isEmpty()) {
        ...
        if(photo == null){
            Toast toast =Toast.makeText(TraineeSignUpActivity.this, "Please Attach your photo",Toast.LENGTH_SHORT);
            toast.show();
            return false;
        }
        if(mobile_number.isEmpty()){
            mobileNumber.setError("Password is required");
