...
public class SharedPrefManager {
    private static final String SHARED_PREF_NAME = "Training App Shared Preference";
    ...
    public boolean saveEmail(String key, String value) {
        editor.putString(key, value);
        return editor.commit();
    }

    public String readEmail(String key, String defaultValue) {
